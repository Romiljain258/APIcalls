...
class PastApi extends React.Component{
    constructor(props){
        super(props);
        this.state={
             items:[],
    ...
    componentDidMount(){
              axios.get('https://hn.algolia.com/api/v1/search?query=%27all%27&hitsPerPage=50')
              .then(json=>{
                                            ...
                                            <a class="list-group-item list-group-item-action p-1 mb-4 word"
                                             ...
                                             href="#list-settings" role="tab"
                                              aria-controls="settings">
                                                  {item.author} author | {item.num_comments} comments | {item.created_at} Time</a>
                                             </div>
                                        </div>
                                   </div>
                            </li>
